...
const GUIDES: GuideItem[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Haz clic en "Create Key", asígnale un nombre (ej. "Grietas Vivas").',
  ...
  },
  {
    ...
    steps: [
      ...
      'Pégala en Grietas Vivas con el modelo "MiniMax-M3" (recomendado para visión).',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Pégala en el apartado NVIDIA NIM de Grietas Vivas.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Copia la clave ("sk-...") y pégala en Grietas Vivas.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Copia tu clave ("sk-ant-...") e ingrésala en Grietas Vivas.',
    ],
